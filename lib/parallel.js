...
function _parallel(name, fn, key) {
  ...
  run = function() {
    var testControlFlow = function(spec) {
...
/**
 * Declares how many tests concurrent tests can run
 *
 * @param {int}   limit
 */
parallel.concurrency = function (limit) {
    semaphore = require('../../semaphore')(limit);
};
